...
if ($estado != '' && $estado != null) {
  ...
  /*LEFT JOIN VIEW_WEBSERV_PRES_INFO_DIREC PI ON D.NOPRESCRIPCION=PI.NOPRESCRIPCION AND D.TIPOTEC= PI.TIPOTEC AND D.CONTEC=PI.CONORDEN */
  ...
  left join WEBSERV_REPORTE_ENTREGA RE on  D.ID=re.id and D.REPO_TIRE_ID=RE.REPO_TIRE_ID AND  
  ...
  LEFT JOIN WEBSERV_SUMINISTROS S ON S.ID=RE.ID AND S.REPO_TIRE_ID=RE.REPO_TIRE_ID AND S.FECANULACION IS NULL 
