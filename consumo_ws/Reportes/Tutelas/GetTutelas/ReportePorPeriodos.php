...
if ($periodo_final < $periodo_inicial) {
  ...
  LEFT JOIN Client C ON C.Clientcode = pp.NROIDPACIENTE /*and C.TYPEDOCUMENTID=pp.TIPOIDPACIENTE*/
  LEFT join GeographicLocation gl_muni  on c.CompanyId = gl_muni.CompanyId and c.GeographicLocationId = gl_muni.GeographicLocationId
  LEFT join GeographicLocation gl_depa  on gl_muni.CompanyId = gl_depa.CompanyId 
