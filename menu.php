  ...
  <aside class="main-sidebar elevation-4 sidebar-light-olive">
    ...
    <a href="#" onclick="location.reload();" class="brand-link">
      ...
      <span class="brand-text font-weight-light">WS AMBUQ MIPRES</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" id="a_panel" onclick="cargarPanel();" class="nav-link">
          ...
          <li id="li_open_sumi" class=" nav-item has-treeview">
            <a id="a_active_sumi" href="#" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li id="li_open_sumi_numero_direc" class="nav-item has-treeview">
                <a href="#" id="a_active_sumi_numero_direc" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                    Direccionamiento
                    <!--Nivel 2-->
          ...
          <li id="li_open_pres" class="nav-item has-treeview">
            <a id="a_active_pres" href="#" class="nav-link">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                PRESCRIPCIÓN
                <!--Nivel 1-->
