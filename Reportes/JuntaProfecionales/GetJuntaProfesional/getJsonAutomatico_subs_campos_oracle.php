...
*/
        ...
        for ($i = 0; $i < $longitud; $i++) {
          ...
          if ($subCadenaPresGene != '') {
            echo "<br>----------------------------------Junta #".$i."-------------------------------------------------------------------------------------";
            //echo "<br> subCadenaPresGene: " . $subCadenaPresGene;
            //NoPrescripcion
            ...
            $cadena_NoPrescripcion = $subCadenaPresGene;
            $posPresInicial = strpos($cadena_NoPrescripcion, $CodEntProc_busc_ini) + strlen($CodEntProc_busc_ini);
            $posPresFinal = strpos($cadena_NoPrescripcion, $CodEntProc_busc_fin);
            $CodEntProc = substr($cadena_NoPrescripcion, $posPresInicial, $posPresFinal - $posPresInicial);
