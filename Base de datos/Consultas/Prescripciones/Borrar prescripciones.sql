...
where  pp.REPO_SERV_ID=3 and pp.REPO_TIRE_ID=2 and pp.REPO_PERIODO BETWEEN '27/01/2020' AND '27/01/2020');
...
where  RJ.SERV_ID=3 and RJ.TIRE_ID=2 and RJ.PERIODO BETWEEN '27/01/2020' AND '27/01/2020';
