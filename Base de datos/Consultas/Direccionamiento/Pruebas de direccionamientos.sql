...
select pp.NOPRESCRIPCION,pp.TIPOTEC,DIR_IDDIRECCIONAMIENTO,DIR_ID,pp.CONORDEN,PP.TIPOIDPACIENTE,PP.NROIDPACIENTE,PP.CODAMBATE,PAA.DESCRIPCION DESC_CODAMBATE,
       PP.CODSERTECAENTREGAR,DESC_CODSERTECAENTREGAR,c.GEOGRAPHICLOCATIONID CodMunEnt,c.Address DirPaciente,c.Regimen 
from (
--MEDICAMENTOS
select PP.NOPRESCRIPCION,'M' as TIPOTEC,DIR_IDDIRECCIONAMIENTO,DIR_ID, PM.CONORDEN,PP.TIPOIDPACIENTE,PP.NROIDPACIENTE,PP.CODAMBATE,
'' CODSERTECAENTREGAR,
...
union
--PROCEDIMIENTOS
select PP.NOPRESCRIPCION,'P' as TIPO_TEC,DIR_IDDIRECCIONAMIENTO,DIR_ID, PPR.CONORDEN,PP.TIPOIDPACIENTE,PP.NROIDPACIENTE,PP.CODAMBATE,
...
union
--PRODUCTOS NUTRICIONALES
select PP.NOPRESCRIPCION,'N' as TIPO_TEC,DIR_IDDIRECCIONAMIENTO,DIR_ID, PPN.CONORDEN,PP.TIPOIDPACIENTE,PP.NROIDPACIENTE,PP.CODAMBATE,
...
union
--SERVICIOS COMPEMENTARIOS
select PP.NOPRESCRIPCION,'S' as TIPO_TEC,DIR_IDDIRECCIONAMIENTO,DIR_ID, SC.CONORDEN,PP.TIPOIDPACIENTE,PP.NROIDPACIENTE,PP.CODAMBATE,
...
union
--DISPOSITIVOS MEDICOS
select PP.NOPRESCRIPCION,'D' as TIPO_TEC,DIR_IDDIRECCIONAMIENTO,DIR_ID, PD.CONORDEN,PP.TIPOIDPACIENTE,PP.NROIDPACIENTE,PP.CODAMBATE,
