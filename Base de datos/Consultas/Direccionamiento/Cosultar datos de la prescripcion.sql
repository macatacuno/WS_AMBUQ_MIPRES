...
left join WEBSERV_PRES_DIRECCIONADOS pd on pd.NOPRESCIPCION=pi.NOPRESCRIPCION and pi.TIPOTEC=pd.TIPOTEC
where  pi.NOPRESCRIPCION='20190118184010019347' and pi.TIPOTEC='P' and pi.CONORDEN=1 and pd.NOENTREGA=1;
--where  NOPRESCRIPCION='20200206186017293511' and TIPOTEC='P' and conorden=3;
