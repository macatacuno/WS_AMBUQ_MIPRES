...
function cargarNumDirecSeguimiento() {
      $('#contenido_principal').load('./consumo_ws/Reportes/Direccionamientos/GetDireccionamiento_seguimiento/vistaDireccionamiento.html');
      jQuery.get("./menu.php", function (resul) {
            $("#div_menu").html(resul);
            $(".nav-link").removeClass("active");//elimina la clase active de cualquir item que la tenga       
            ...
            $("#a_active_sumi").addClass("active");//agrega la clase active al item seleccionado
            $("#a_active_sumi_numero_direc").addClass("active");//agrega la clase active al item seleccionado
            $("#a_active_sumi_numero_direc_seguimiento").addClass("active");//agrega la clase active al item seleccionado
      })
...
function cargarEntregaXFechaSinReportar() {
      $('#contenido_principal').load('./consumo_ws/reportes/ReporteEntrega/GetReporteEntregaXFechaSinReportar/vistaEntregaXFecha.html');
      jQuery.get("./menu.php", function (resul) {
            $("#div_menu").html(resul);
            $(".nav-link").removeClass("active");//elimina la clase active de cualquir item que la tenga       
...
function cargarsuministroRepoMasi() {
      //$('#contenido_principal').load('./vistas/pagina_en_construccion.html');
      $('#contenido_principal').load('./consumo_ws/envios/SuministrosReporteMasivo/vistaRepoSumiMasi.html');
      jQuery.get("./menu.php", function (resul) {
            $("#div_menu").html(resul);
            $(".nav-link").removeClass("active");//elimina la clase active de cualquir item que la tenga       
            ...
            $("#a_active_sumi").addClass("active");//agrega la clase active al item seleccionado
            $("#a_active_sumi_suministro").addClass("active");//agrega la clase active al item seleccionado
            $("#a_active_sumi_reporte_masivo").addClass("active");//agrega la clase active al item seleccionado
      })
}
